...
| Release | 1.0 |
| Source baseline | Appendix E RC2 |
| Intended audience | Platform owner, system administrators, technical maintainers |
| Status | Definitive release |

> **Document scope.** This appendix defines the standard procedures used to operate, maintain, and recover the LMWPool production platform. Read it together with Volumes 1–4 and Appendices A–F for the complete platform reference.
...
Unlike the preceding appendices, which describe infrastructure, configuration, and APIs, this appendix focuses on operational execution.

Every runbook provides a deterministic sequence of actions intended to minimize operational risk while ensuring repeatable outcomes. For supporting commands, configuration details, and infrastructure procedures, see Appendix B, *Command Reference*; Appendix C, *Configuration Reference*; and Volume 4, *Infrastructure Operations*.

---

## Table of Contents

- [E.1 Operational Philosophy](#e1-operational-philosophy)
- [E.2 Daily Operations](#e2-daily-operations)
- [E.3 Startup Procedures](#e3-startup-procedures)
- [E.4 Shutdown Procedures](#e4-shutdown-procedures)
- [E.5 Planned Maintenance](#e5-planned-maintenance)
- [E.6 Incident Response](#e6-incident-response)
- [E.7 CKPool Recovery](#e7-ckpool-recovery)
- [E.8 `bitcoind-xec` Recovery](#e8-bitcoind-xec-recovery)
- [E.9 Blockchain Notary Recovery](#e9-blockchain-notary-recovery)
- [E.10 Disaster Recovery](#e10-disaster-recovery)
- [E.11 Health Verification](#e11-health-verification)
- [E.12 Operational Checklist](#e12-operational-checklist)
- [E.13 Appendix Summary](#e13-appendix-summary)
...
Use the following recommended startup sequence:
...
Use the following recommended sequence:
...
These procedures establish a repeatable operational framework that complements the architectural, configuration, and API documentation contained in the other volumes and appendices.
